                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="card col-md-6 offset-md-3">
                            <h3 className="text-center">Update the bus</h3>
                            <div className="card-body">
                                <form>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <Form.Select defaultValue="1" value={this.state.vehicle}
                                            ...
                                            {this.state.vehicles.map(item => {
                                                return <option
                                                    value={item.licensePlate}>{item.licensePlate} / {item.seat} chair</option>
                                            })
                                            }
                                        </Form.Select>
                                        {
                                        ...
                                        <Row>
                                            ...
                                            <Col>
                                                ...
                                                <Form.Select defaultValue="1" value={this.state.assistant}
                                                             ...
                                                             className="form-control">
                                                    <option value="">Choose 1 vehicle</option>
                                                    {this.state.drivers.map(item => {
                                    ...
                                    <button className="btn btn-success" onClick={this.updateJourney}>Update
                                    </button>
