    ...
    render() {
        return (
            <div>
                ...
                <div className="row">
                    <button className="btn btn-primary" onClick={this.addJourney}>More rides</button>
                ...
                <div className="row">
                    <table className="table table-striped table-bordered">
                        ...
                        {this.state.journeys.map(journey =>
                            <tr key={journey.id}>
                                ...
                                <td>{journey.vehicle.licensePlate} / {journey.vehicle.seat} chair</td>
                                ...
                                <td className="text-center">
                                    <button className="btn btn-info"
                                            onClick={() => this.updateJourney(journey.id)}>Fix
                                    </button>
                    ...
                    Total results: {this.state.total} buses
                </div>
                <div>
