                            ...
                            <div className="card-body">
                                <form>
                                    <div className="form-group">
                                        ...
                                        <input disabled placeholder="Enter number plate" name="licensePlate" className="form-control"
                                    ...
                                    <button className="btn btn-success" onClick={this.updateVehicle}>Update
                                    </button>
