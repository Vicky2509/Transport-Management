                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="card col-md-6 offset-md-3">
                            <h3 className="text-center">Update route information</h3>
                            <div className="card-body">
                                <form>
                                    <div className="form-group">
                                        <label>First point: </label>
                                        <input placeholder="Enter the starting point" name="first_point" className="form-control"
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input placeholder="Enter endpoint" name="end_point" className="form-control"
                                    ...
                                    <div className="form-group">
                                        <label>Distance length: </label>
                                        <input placeholder="Enter the distance" name="length"
                                    ...
                                    <div className="form-group">
                                        ...
                                        <Form.Select defaultValue="1" value={this.state.complexity}
                                            ...
                                            <option value="">Choose 1 type of complexity</option>
                                    ...
                                    <button className="btn btn-success" onClick={this.updateRoute}>Update
                                    </button>
