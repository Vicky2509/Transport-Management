                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="card col-md-6 offset-md-3">
                            <h3 className="text-center">More routes</h3>
                            <div className="card-body">
                                <form>
                                    <div className="form-group">
                                        <label>First point: </label>
                                        <input placeholder="Enter First point" name="first_point" className="form-control"
                                    ...
                                    <button className="btn btn-success" onClick={this.saveRoute}>Save
                                    </button>
